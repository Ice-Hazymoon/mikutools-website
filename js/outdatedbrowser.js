...
addLoadEvent(function () {
    var _outdatedbrowser_div = document.createElement('div');
    _outdatedbrowser_div.setAttribute('id', 'outdated');
    document.getElementsByTagName('body')[0].appendChild(_outdatedbrowser_div);
